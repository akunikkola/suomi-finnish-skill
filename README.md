...
- **Mangled ä and ö**: LLMs drop or swap Finnish diacritics, writing "a" instead of "ä" and "o" instead of "ö", which changes word meanings entirely (*tuli* = fire, *tuuli* = wind; *maa* = land, *mää* = dialectal "I")
